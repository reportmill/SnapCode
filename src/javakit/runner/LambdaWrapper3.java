...
public class LambdaWrapper3 {
     ...
     * Constructor.
     */
    public LambdaWrapper3(JSExprEval exprEval, Object anOR, JExprLambda lambdaExpr)
    {
        _exprEval = exprEval;
    ...
    public static Object getWrappedLambdaExpressionImpl(JSExprEval exprEval, Object anOR, JExprLambda lambdaExpr, JavaClass lambdaClass) throws Throwable
    {
        ...
        LambdaWrapper3 lambdaWrapper = new LambdaWrapper3(exprEval, anOR, lambdaExpr);
