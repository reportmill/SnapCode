 ...
 */
public class WelcomePanelX extends ViewOwner {
    ...
    // The shared instance
    private static WelcomePanelX _shared;

    /**
     * Returns the shared instance.
     */
    public static WelcomePanelX getShared()
    {
        if (_shared != null) return _shared;
        return _shared = new WelcomePanelX();
    }
    ...
    protected void initUI()
    {
        ...
        WelcomePanelAnimX anim = new WelcomePanelAnimX();
     ...
     */
    private static class WelcomePanelAnimX extends ViewOwner {
