...
public class StaticResolver extends javakit.resolver.StaticResolver {
    ...
    public JavaMethod[] getMethodsForClass(Resolver aResolver, String aClassName)
    {
        ...
        switch (aClassName) {
            ...
            case "snapcode.app.QuickDrawPen":
                ...
                mb.name("forward").paramTypes(double.class).returnType(void.class).save();
                mb.name("turn").paramTypes(double.class).returnType(void.class).save();
                mb.name("getAnimPen").returnType(snapcode.app.QuickDrawPen.class).save();
    ...
    public Object invokeMethod(String anId, Object anObj, Object ... theArgs) throws Exception
    {
        switch (anId) {
            ...
            // Handle snapcode.app.QuickDraw
            case "snapcode.app.QuickDraw.isShowGrid()":
                return ((snapcode.app.QuickDraw) anObj).isShowGrid();
            case "snapcode.app.QuickDraw.isAnimate()":
                return ((snapcode.app.QuickDraw) anObj).isAnimate();
            case "snapcode.app.QuickDraw.setAnimate(boolean)":
                ((snapcode.app.QuickDraw) anObj).setAnimate(boolVal(theArgs[0])); return null;
            ...
            case "snapcode.app.QuickDraw.setShowGrid(boolean)":
                ((snapcode.app.QuickDraw) anObj).setShowGrid(boolVal(theArgs[0])); return null;
            case "snapcode.app.QuickDraw.getGridSpacing()":
                return ((snapcode.app.QuickDraw) anObj).getGridSpacing();
