 ...
 */
public class AppX extends AppBase {
    ...
    {
        WelcomePanelX.getShared().showPanel();
    }
    ...
    {
        return WelcomePanelX.getShared().getProjectSiteForName(aName);
    }
    ...
    {
        return WelcomePanelX.getShared().createProjectSiteForName(aName);
    }
