 ...
 */
public class WelcomePanelJr extends ViewOwner {
    ...
    // The shared instance
    private static WelcomePanelJr _shared;
     ...
     */
    public static WelcomePanelJr getShared()
    {
        if (_shared != null) return _shared;
        return _shared = new WelcomePanelJr();
    }
    ...
    /**
     * Override to use WelcomePanel.
     */
    @Override
    protected View createUI()
    {
        return createUIForClass(WelcomePanel.class);
    }
    ...
    private DocView getAnimView()
    {
        ...
        WebURL url = WebURL.getURL(WelcomePanelJr.class, "WelcomePanelAnim.snp");
