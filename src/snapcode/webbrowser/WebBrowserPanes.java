...
public class WebBrowserPanes {
    ...
    public static class iPhone extends WebBrowserPane {
        ...
        protected View createUI()
        {
            ...
            double sc = .75;
            View superUI = super.createUI();
            superUI.setPrefSize(1024 * sc, 768 * sc);
